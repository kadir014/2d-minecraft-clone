...
`W`, `SPACE` keys to jump \
`LMB` to break blocks \
`RMB` to place blocks \
`F3` to toggle display debug info \
`P` to toggle lighting

## Todo (until alpha version state)
- [ ] Better code organization
- [ ] Finish entity-mob system
- [ ] Add entity visuals and animations
- [ ] Better lighting system
- [ ] Add more tiles
- [ ] Add GUI (hotbar, inventory, ...)
